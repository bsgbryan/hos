...
# Default to a macOS serial device name
# (because that's what I'm using for development currently)
DEV_SERIAL ?= /dev/tty.usbserial-0001
# Default to a serial device name that is common in Linux; if you're using Linux,
...
##------------------------------------------------------------------------------
## Push the JTAG boot image to the real hardware
##------------------------------------------------------------------------------
jtagboot:
...
## Start GDB session
##------------------------------------------------------------------------------
gdb: RUSTC_MISC_ARGS += debuginfo=2
